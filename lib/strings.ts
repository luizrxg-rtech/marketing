export const strings = {
  pt: {
    ...
    cases: {
      ...
      description: 'Grandes marcas que aceleraram seu processo de crescimento com a Boomer. Veja os resultados:',
      items: [
        {
    ...
    method: {
      title: 'Método Boomer',
      description: 'A Boomer planeja e executa toda a jornada da sua empresa pelo digital.',
      steps: {
        startup: {
          title: 'START UP',
    ...
    faq: {
      ...
      subtitle: 'Sobre algumas dúvidas sobre como o Método Boomer pode transformar seus resultados no digital.',
      questions: [
        {
          question: 'Como funciona o processo de trabalho da Boomer?',
  ...
  en: {
    ...
    cases: {
      ...
      description: 'Great brands that accelerated their growth process with Boomer. See the results:',
      items: [
        {
    ...
    method: {
      title: 'Boomer Method',
      description: 'Boomer plans and executes your entire company journey through digital.',
      steps: {
        startup: {
          title: 'START UP',
    ...
    faq: {
      ...
      subtitle: 'About some questions about how the Boomer Method can transform your digital results.',
      questions: [
        {
          question: 'How does Boomer\'s work process work?',
